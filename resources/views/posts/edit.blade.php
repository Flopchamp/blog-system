                    ...
                    <form method="POST" action="{{ route('posts.update', $post) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="excerpt" 
                                      ...
                                      rows="3"
                                      style="width: 100%; padding: 12px; border: 2px solid #e5e7eb; border-radius: 8px; font-size: 16px;"
                                      placeholder="A brief summary of your post (optional)...">{{ old('excerpt', $post->excerpt) }}</textarea>
                            @error('excerpt')
                                <p style="color: #ef4444; font-size: 14px; margin-top: 5px;">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="mb-6">
                            ...
                            <p style="font-size: 13px; color: #6b7280; margin-top: 5px;">
                                {{ $post->featured_image ? 'Leave empty to keep current image' : 'Max 2MB (JPG, PNG, GIF)' }}
                            </p>
                        </div>
